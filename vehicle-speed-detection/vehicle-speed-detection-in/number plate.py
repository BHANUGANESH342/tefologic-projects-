...
noPlateCascade = cv2.CascadeClassifier(r"C:\Users\rkssp\Downloads\haarcascade_russian_plate_number.xml")
...
OUTPUT_FOLDER = r"C:\Users\rkssp\Desktop\TEFOlogic PROJECTS\vehicle-speed-detection\output"
    ...
    while True:
        ...
        for (x, y, w, h) in nPlates:
            ...
            if area > 500:
                ...
                cv2.putText(resultImage, 'Number Plate', (x, y-5), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 255, 0), 2)
